...
class Personnel(Base):
    ...
    qlf = Column(String, nullable=True)
    date_of_reassignment = Column(DateTime, nullable=True)
    designation = Column(String, nullable=True)
    date_of_designation = Column(DateTime, nullable=True)
    highest_eligibility = Column(String, nullable=True)
    contact_number = Column(String, nullable=True)
    birthdate = Column(DateTime, nullable=False)
    religion = Column(String, nullable=False)
    section = Column(String, nullable=True)
    status = Column(String, nullable=False)
    status_custom = Column(String, nullable=True)
    # NUP-specific fields
    nup_rank = Column(String, nullable=True)
    nup_entry_number = Column(Integer, nullable=True)
...
class BMIRecord(Base):
    ...
    # Status for BMI record (Active/Inactive/Reassign/Retired/Others)
